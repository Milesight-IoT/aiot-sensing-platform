...
/**
 * Cassandra implementation of {@link TimeseriesService}.
 * @author Andrew Shvayka
 */
public interface TimeseriesDao {

    ListenableFuture<Void> deleteByAsync(TenantId tenantId, QueryCursor cursor, SimpleListenableFuture<Void> resultFuture);

    ListenableFuture<Void> deleteBatchAsync(TenantId tenantId, BatchDeleteTsKv cursor, SimpleListenableFuture<Void> resultFuture);
