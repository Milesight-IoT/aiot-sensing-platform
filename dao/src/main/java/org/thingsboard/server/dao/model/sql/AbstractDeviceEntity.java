...
public abstract class AbstractDeviceEntity<T extends Device> extends BaseSqlEntity<T> implements SearchTextEntity<T> {
    ...
    @Column(name = ModelConstants.DEVICE_CONFIGURE_ID_PROPERTY, columnDefinition = "uuid")
    ...
    public AbstractDeviceEntity(Device device) {
        ...
        if (device.getConfigureId() != null) {
            this.configureId = device.getConfigureId().getId();
        }
    ...
    public AbstractDeviceEntity(DeviceEntity deviceEntity) {
        ...
        this.configureId = deviceEntity.getConfigureId();
    ...
    protected Device toDevice() {
        ...
        if (configureId != null) {
            device.setConfigureId(new OtaPackageId(configureId));
        }
        if (softwareId != null) {
