...
public class JpaDeviceDao extends JpaAbstractSearchTextDao<DeviceEntity, Device> implements DeviceDao {
    ...
    @Override
    public Device findByCredentialsId(UUID tenantId, String credentialsId) {
        return DaoUtil.getData(deviceRepository.findByCredentialsId(tenantId, credentialsId));
    }
