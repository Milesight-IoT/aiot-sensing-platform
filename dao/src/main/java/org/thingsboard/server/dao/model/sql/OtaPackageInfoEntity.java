...
import static org.thingsboard.server.dao.model.ModelConstants.OTA_PACKAGE_DISTRIBUTE_STATUS_COLUMN;
...
public class OtaPackageInfoEntity extends BaseSqlEntity<OtaPackageInfo> implements SearchTextEntity<OtaPackageInfo> {
    ...
    @Column(name = OTA_PACKAGE_DISTRIBUTE_STATUS_COLUMN)
    ...
    public OtaPackageInfoEntity(OtaPackageInfo otaPackageInfo) {
        ...
        this.distributeStatus = otaPackageInfo.getDistributeStatus();
    }
    ...
    public OtaPackageInfoEntity(UUID id, long createdTime, UUID tenantId, UUID deviceProfileId, OtaPackageType type, String title, String version, String tag,
                                ...
                                Object additionalInfo, boolean hasData, Boolean distributeStatus) {
        this.id = id;
    ...
    public OtaPackageInfoEntity(UUID id, long createdTime, UUID tenantId, UUID deviceProfileId, OtaPackageType type, String title, String version, String tag,
                                String url, String fileName, String contentType, ChecksumAlgorithm checksumAlgorithm, String checksum, Long dataSize,
                                Object additionalInfo, boolean hasData, String deviceProfileName, Boolean distributeStatus) {
        this.id = id;
        this.createdTime = createdTime;
        this.tenantId = tenantId;
        this.deviceProfileId = deviceProfileId;
    ...
    public OtaPackageInfo toData() {
        ...
        otaPackageInfo.setDeviceProfileName(deviceProfileName);
        otaPackageInfo.setDistributeStatus(distributeStatus);
