...
public class JpaDashboardDao extends JpaAbstractSearchTextDao<DashboardEntity, Dashboard> implements DashboardDao {
    ...
    @Override
    public Dashboard findByTenantIdAndCreatedTime(UUID tenantId, long createdTime){
        return DaoUtil.getData(dashboardRepository.findByTenantIdAndCreatedTime(tenantId, createdTime));
    }
