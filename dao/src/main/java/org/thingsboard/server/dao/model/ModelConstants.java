...
public class ModelConstants {
    ...
    public static final String DEVICE_CONFIGURE_ID_PROPERTY = "configure_id";
    ...
    public static final String DEVICE_PROFILE_CONFIGURE_ID_PROPERTY = "configure_id";
    public static final String DEVICE_PROFILE_PROFILE_TYPE_PROPERTY = "profile_type";
    ...
    public static final String OTA_PACKAGE_DISTRIBUTE_STATUS_COLUMN = "distribute_status";
    ...
    // **********************************************
    /**
     * device_ability constants.
     */
    public static final String DEVICE_ABILITY_TABLE = "device_ability";
    public static final String DEVICE_ABILITY_ABILITY_COLUMN = "ability";
    public static final String DEVICE_ABILITY_ABILITY_TYPE_COLUMN = "ability_type";
    public static final String DEVICE_ABILITY_ATTRIBUTES_COLUMN = "attributes";
    public static final String DEVICE_ABILITY_EXTRA_INFO_COLUMN = "extra_info";
    public static final String DEVICE_ABILITY_SENSING_OBJECT_ID_COLUMN = "sensing_object_id";

    /**
     * telemetry_recognition constants.
     */
    public static final String TELEMETRY_RECOGNITION_TABLE = "telemetry_recognition";
    public static final String TELEMETRY_RECOGNITION_TS_COLUMN = "ts";
    public static final String TELEMETRY_RECOGNITION_ABILITY_COLUMN = "ability";
    public static final String TELEMETRY_RECOGNITION_TYPE_COLUMN = "ability_type";
    public static final String TELEMETRY_RECOGNITION_VALUE_COLUMN = "value";
    public static final String TELEMETRY_RECOGNITION_EXTRA_INFO_COLUMN = "extra_info";

    /**
     * attribute_recognition constants.
     */
    public static final String ATTRIBUTE_RECOGNITION_TABLE = "attribute_recognition";
    public static final String ATTRIBUTE_RECOGNITION_ATTRIBUTE_TYPE_COLUMN = "attribute_type";
    public static final String ATTRIBUTE_RECOGNITION_ATTRIBUTE_COLUMN = "attribute";

    /**
     * sensing_object constants.
     */
    public static final String SENSING_OBJECT_TABLE = "sensing_object";
    public static final String SENSING_OBJECT_NAME_COLUMN = "name";
    public static final String SENSING_OBJECT_DEVICE_ABILITY_IDS_COLUMN = "device_ability_ids";


    /**
     * rule_node_tenant_associate constants.
     */
    public static final String RULE_CHAIN_ASSOCIATE = "rule_chain_associate";
    public static final String RULE_CHAIN_ASSOCIATE_ASSOCIATE_ID_COLUMN = "associate_id";
    public static final String RULE_CHAIN_ASSOCIATE_TYPE_COLUMN = "type";
    public static final String RULE_CHAIN_ASSOCIATE_RULE_ID_COLUMN = "rule_id";

    /**
     * rule_chain_own constants.
     */
    public static final String RULE_CHAIN_OWN = "rule_chain_own";
    public static final String RULE_CHAIN_OWN_RULE_CHAIN_ID_COLUMN = "rule_chain_id";
    public static final String RULE_CHAIN_OWN_RULE_NODE_ID_COLUMN = "rule_node_id";
    public static final String RULE_CHAIN_OWN_NAME_COLUMN = "name";
    public static final String RULE_CHAIN_OWN_TRIGGER_COLUMN = "trigger";
    public static final String RULE_CHAIN_OWN_ATIONS_COLUMN = "actions";
    public static final String RULE_CHAIN_OWN_JSON_DATA_COLUMN = "json_data";

    /**
     * dashboard_rule_devices
     */
    public static final String DASHBOARD_RULE_DEVICES_TABLE = "dashboard_rule_devices";
    public static final String DASHBOARD_RULE_DEVICES_CREATED_TIME_COLUMN = "created_time";
    public static final String DASHBOARD_RULE_DEVICES_TYPE_COLUMN = "type";
    public static final String DASHBOARD_RULE_DEVICES_VALUE_COLUMN = "value";
    public static final String DASHBOARD_RULE_DEVICES_RULE_NAME_COLUMN = "rule_name";

    /**
     * recipients constants.
     */
    public static final String RECIPIENTS = "recipients";
    public static final String RECIPIENTS_UPDATED_TIME_COLUMN = "updated_time";
    public static final String RECIPIENTS_NAME_COLUMN = "name";
    public static final String RECIPIENTS_RULE_TRANSMISSION_TYPE_COLUMN = "transmission_type";
    public static final String RECIPIENTS_JSON_DATA_COLUMN = "json_data";
    public static final String RECIPIENTS_USERNAME_COLUMN = "username";
    public static final String RECIPIENTS_PASSWORD_COLUMN = "password";
