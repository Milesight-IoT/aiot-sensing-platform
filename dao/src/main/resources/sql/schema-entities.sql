...
CREATE TABLE IF NOT EXISTS device_ability (
    id uuid NOT NULL CONSTRAINT device_ability_pkey PRIMARY KEY,
    created_time bigint NOT NULL,
    device_id uuid,
    ability varchar(64),
    ability_type bigint,
    ...
    extra_info varchar,
    sensing_object_id uuid,
    CONSTRAINT device_id_ability_unq_key UNIQUE (device_id, ability)
);

CREATE TABLE IF NOT EXISTS sensing_object (
    id uuid NOT NULL CONSTRAINT sensing_object_pkey PRIMARY KEY,
    created_time bigint NOT NULL,
    tenant_id uuid,
    name varchar(64),
    device_ability_ids varchar,
    CONSTRAINT tenant_id_name_unq_key UNIQUE (tenant_id, name)
);

CREATE TABLE IF NOT EXISTS telemetry_recognition (
    id uuid NOT NULL CONSTRAINT telemetry_recognition_pkey PRIMARY KEY,
    created_time bigint NOT NULL,
    updated_time bigint,
    device_id uuid,
    ts bigint,
