...
CREATE UNIQUE INDEX IF NOT EXISTS idx_device_id_ability_ts ON telemetry_recognition(device_id, ability, ts);

CREATE INDEX IF NOT EXISTS idx_ts ON telemetry_recognition(ts);
