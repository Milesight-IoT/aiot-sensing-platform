...
public interface OtaPackageService extends EntityDaoService {
    ...
    OtaPackageInfo findFirmwareByDeviceId(UUID deviceId);

    OtaPackageInfo findFirmwareByCredentialsId(String credentialsId);

    OtaPackageInfo findConfigureByDeviceId(UUID deviceId);

    OtaPackageInfo findConfigureByCredentialsId(String credentialsId);

    OtaPackageInfo findByTenantIdAndTitleAndVersion(TenantId tenantId, String title, String version);

    OtaPackageInfo findByTenantIdAndTitle(TenantId tenantId, String title);
}
