...
public interface DeviceService extends EntityDaoService {
    ...
    CurrentDeviceOtaPackage getDeviceOtaPackageById(TenantId tenantId, DeviceId deviceId) throws ExecutionException, InterruptedException;

    Device findByTenantIdAndName(TenantId tenantId, String name);

    Device findByCredentialsId(TenantId tenantId, String credentialsId);
}
