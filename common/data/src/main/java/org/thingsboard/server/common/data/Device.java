...
public class Device extends SearchTextBasedWithAdditionalInfo<DeviceId> implements HasLabel, HasTenantId, HasCustomerId, HasOtaPackage, ExportableEntity<DeviceId> {
    ...
    private OtaPackageId configureId;
    ...
    public Device(Device device) {
        ...
        this.configureId = device.getConfigureId();
    ...
    public Device updateDevice(Device device) {
        ...
        this.setConfigureId(device.getConfigureId());
    ...
    @ApiModelProperty(value = "JSON object with Ota Package Id.")
    public OtaPackageId getConfigureId() {
        return configureId;
    }
    ...
    public void setConfigureId(OtaPackageId configureId) {
