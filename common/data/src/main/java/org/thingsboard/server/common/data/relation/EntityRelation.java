...
public class EntityRelation implements Serializable {
    ...
    public static final String POST_TELEMETRY = "Post telemetry";
    public static final String POST_ATTRIBUTES = "Post attributes";
    public static final String MS_ROI_PASSAGE = "Ms Roi Passage";
