...
public class JsonConverter {
    ...
    public static TransportProtos.ToServerRpcMsMsg convertToServerRpcMsMsg(JsonElement parse, String requestKey) {
        JsonObject object = parse.getAsJsonObject();
        TransportProtos.ToServerRpcMsMsg.Builder builder = TransportProtos.ToServerRpcMsMsg.newBuilder();
        builder.setRequestKey(requestKey);
    ...
    public static JsonObject toJson(ToDeviceMsMsg payload) {
