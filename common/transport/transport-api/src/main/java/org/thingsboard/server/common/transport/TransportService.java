...
public interface TransportService {
    ...
    void process(SessionInfoProto sessionInfo, SubscribeToDeviceMsMsg msg, TransportServiceCallback<Void> callback);
    ...
    void process(SessionInfoProto sessionInfo, ToServerRpcMsMsg toServerRpcMsMsg, TransportServiceCallback<Void> pubAckCallback);
