...
public class ProtoConverter {
    ...
    public static TransportProtos.ToServerRpcMsMsg convertToServerRpcMsMsg(byte[] bytes, String requestKey) throws InvalidProtocolBufferException {
        TransportApiProtos.RpcMs proto = TransportApiProtos.RpcMs.parseFrom(bytes);
        String method = proto.getMessage();
        return TransportProtos.ToServerRpcMsMsg.newBuilder().setRequestKey(requestKey).setMessage(method).build();
    }
