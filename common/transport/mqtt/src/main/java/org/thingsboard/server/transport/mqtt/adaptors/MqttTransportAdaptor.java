...
public interface MqttTransportAdaptor {
    ...
    Optional<MqttMessage> convertToPublish(MqttDeviceAwareSessionContext ctx, TransportProtos.ToDeviceMsMsg toDeviceMsMsg, String topicBase) throws UnsupportedEncodingException;

    ToServerRpcMsMsg convertToServerRpcMsMsg(MqttDeviceAwareSessionContext ctx, MqttPublishMessage inbound, String topicBase) throws AdaptorException;
