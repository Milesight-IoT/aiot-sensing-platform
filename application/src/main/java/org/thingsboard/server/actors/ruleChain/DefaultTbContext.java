...
class DefaultTbContext implements TbContext {
    ...
    @Override
    public SensingObjectService getSensingObjectService() {
        return mainCtx.getSensingObjectService();
    }
    @Override
    public DeviceAbilityService getDeviceAbilityService() {
        return mainCtx.getDeviceAbilityService();
    }

    @Override
    public DashboardRuleDevicesService getDashboardRuleDevicesService() {
        return mainCtx.getDashboardRuleDevicesService();
    }

    @Override
    public RecipientsService getRecipientsService() {
        return mainCtx.getRecipientsService();
    }
