...
import org.thingsboard.server.service.ms.MsDbDataServiceService;
...
public abstract class AbstractPartitionBasedService<T extends EntityId> extends TbApplicationEventListener<PartitionChangeEvent> {
    ...
    @Autowired
    protected MsDbDataServiceService msDbDataServiceService;

    @Autowired
    protected PartitionService partitionService;
    protected ListeningScheduledExecutorService scheduledExecutor;
    protected ListeningScheduledExecutorService msDbDataScheduledExecutor ;
    ...
    protected void init() {
        ...
        msDbDataScheduledExecutor = MoreExecutors.listeningDecorator(Executors.newSingleThreadScheduledExecutor(ThingsBoardThreadFactory.forName("ms-db-data")));
    }
    ...
    protected void onTbApplicationEvent(PartitionChangeEvent partitionChangeEvent) {
        if (getServiceType().equals(partitionChangeEvent.getServiceType())) {
            ...
            msDbDataScheduledExecutor.submit(() -> msDbDataServiceService.initMsDbData());
        }
    }
