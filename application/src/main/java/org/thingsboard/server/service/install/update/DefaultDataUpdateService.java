...
public class DefaultDataUpdateService implements DataUpdateService {
    ...
    public void updateData(String fromVersion) throws Exception {
        switch (fromVersion) {
            ...
            case "3.4.1":
                ...
                break;
            case "1.0.1.1":
                log.info("Updating data from version 1.0.0.1 to 1.0.1.1 ...");
                systemDataLoaderService.updateDashboardAndWidgets();
                tenantsDashboardUpdater.updateEntities(null);
                tenantsRuleChainUpdater.updateEntities(null);
                break;
            case "1.0.1.1-r1":
                log.info("Updating data from version 1.0.1.1 to 1.0.1.1-r1 ...");
                tenantsRuleChainUpdaterR1.updateEntities();
                break;
            default:
    ...
    private final PaginatedUpdater<String, Tenant> tenantsRuleChainUpdater =
            new PaginatedUpdater<>() {
    ...
    private final PaginatedUpdater<String, Tenant> tenantsRuleChainUpdaterR1 =
            new PaginatedUpdater<>() {
    ...
    private final PaginatedUpdater<String, Tenant> tenantsDashboardUpdater =
            new PaginatedUpdater<>() {
                ...
                protected void updateEntity(Tenant tenant) {
                    try {
                        ...
                        List<Dashboard> alreadyDash = dashboardService.findTenantDashboardsByTitle(tenant.getId(), defaultString);
                        if (CollectionUtils.isEmpty(alreadyDash)) {
                            // 增加一个默认仪表盘
                            ...
                            dashboard.setTitle(defaultString);
