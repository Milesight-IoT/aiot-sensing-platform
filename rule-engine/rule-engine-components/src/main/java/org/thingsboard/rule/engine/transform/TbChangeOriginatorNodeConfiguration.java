...
@Data
public class TbChangeOriginatorNodeConfiguration extends TbTransformNodeConfiguration implements NodeConfiguration<TbChangeOriginatorNodeConfiguration> {
