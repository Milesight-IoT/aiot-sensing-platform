...
public interface TbContext {
    ...
    SensingObjectService getSensingObjectService();

    DeviceAbilityService getDeviceAbilityService();

    DashboardRuleDevicesService getDashboardRuleDevicesService();
    RecipientsService getRecipientsService();
