...
export function useTags() {
    ...
    /**
     * 内容区域全屏
     * @returns isFull 返回目前全屏状态
     */
    function onContentFullScreen() {
        pureSetting.hiddenSideBar
            ? pureSetting.changeSetting({ key: 'hiddenSideBar', value: false }) // Exit Full Screen
            : pureSetting.changeSetting({ key: 'hiddenSideBar', value: true }); // Full Screen
        return pureSetting.hiddenSideBar;
    }
