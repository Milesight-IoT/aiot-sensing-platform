...
const getSectionStyle = computed(() => {
    return [
        hideTabs.value && layout ? 'padding-top: 58px;' : '',
        !hideTabs.value && layout ? 'padding-top: 95px;' : '',
        hideTabs.value && !layout.value ? 'padding-top: 58px' : '',
        !hideTabs.value && !layout.value ? 'padding-top: 95px;' : '',
