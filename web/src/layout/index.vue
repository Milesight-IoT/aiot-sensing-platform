...
<template>
    <div :class="['app-wrapper', set.classes]" v-resize>
        ...
        <Vertical
            ...
            "
        />
        <div :class="['main-container', pureSetting.hiddenSideBar || userInfo.isPublic ? 'main-hidden' : '']">
            <div v-if="set.fixedHeader">
                <layout-header v-if="!userInfo.isPublic" />
                <!-- 主体内容 -->
                <app-main :fixed-header="set.fixedHeader && !userInfo.isPublic" />
            </div>
            <el-scrollbar v-else>
